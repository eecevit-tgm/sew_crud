...
export default {
  ...
  methods: {
    ...
    initForm() {
      ...
      this.addBookForm.email = '';
      this.addBookForm.picture = '';
    },
    onSubmit(evt) {
      evt.preventDefault();
      ...
      const payload = {
        username: this.addBookForm.username,
        email: this.addBookForm.email,
        picture: this.addBookForm.picture
      };
